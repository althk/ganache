...
func New(tlsCfg *grpcutils.TLSConfig, etcdSpec, csResolverPrefix string, shardCount int) (*service.CFE, error) {
	...
	for i := 0; i < shardCount; i++ {
		c[i], err = getCacheCli(tlsCfg, r, csResolverPrefix, i)
		if err != nil {
			return nil, err
		}
	}
...
func getCacheCli(tlsCfg *grpcutils.TLSConfig, r resolver.Builder, cacheResolverPrefix string, shardNum int) (cspb.CacheClient, error) {
